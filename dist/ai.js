...
const extractHotelData = (filePath, supplierId, country, city, currency, requestId, createdBy, stars, fileUrl) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        try {
            yield HotelRequest_1.default.findByIdAndUpdate(requestId, { isComplete: true }, { new: true });
        }
        catch (dbError) {
        ...
        try {
            yield HotelRequest_1.default.findByIdAndUpdate(requestId, { isComplete: true, hasError: true, errorMessage: error.message }, { new: true });
        }
        catch (dbError) {
